...
export default function NonApprovedPartnersTab() {
    ...
    const [customPassword, setCustomPassword] = useState("Shop Genuine");
    ...
    const openApproveDialog = (id: string) => {
        setApproveId(id);
        setApproveApiError("");
        setCustomPassword("Shop Genuine");
    ...
    const handleApprove = async () => {
        const passwordToSend = customPassword.trim().length >= 6 ? customPassword.trim() : "Shop Genuine";
                ...
                <DialogContent>
                    ...
                    <div className="rounded-xl border border-green-200 bg-green-50 p-4 space-y-3">
                        ...
                        <div className="text-xs text-green-700 space-y-0.5">
                            <p>Partner dashboard: <strong>partner.shopgenuine.online</strong></p>
