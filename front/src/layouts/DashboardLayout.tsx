...
export default function DashboardLayout() {
  ...
  useEffect(() => {
    ...
    } else if (path.startsWith("/products") || path.startsWith("/brands") || path.startsWith("/store-verticals") || path.startsWith("/categories") || path.startsWith("/attributes")) {
      setOpenSections({
        products: true,
        orders: false,
        users: false,
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-background">
        ...
        <nav className="flex-1 p-3 overflow-y-auto scrollbar-hide">
          <SafeRender>
            <div className="flex flex-col gap-0.5">
              ...
              {/* Bundle Management - Single Item (Hidden) */}
              {/* <NavItem
                href="/bundles"
              ...
              {/* Fragrance Finder - Collapsible (Hidden as requested) */}
              {/* <CollapsibleNavItem
              ...
              {/* Custom Fragrance Management & Bespoke Orders (Hidden as requested) */}
              {/* <NavItem
                href="/custom-perfume"
              ...
              <CollapsibleNavItem
                ...
                children={[
                  ...
                  {
                    href: "/store-verticals",
                    title: "Store Verticals",
                    icon: <Tags className="h-3 w-3" />,
                    hasPermission: hasPermissionFor(
                      admin,
                      Resource.STORE_VERTICALS,
                      Action.READ
                    ),
                  },
                  {
      ...
      {/* Main content */}
      <div className="flex flex-col flex-1 min-h-0 min-w-0 lg:ml-[240px] w-full lg:w-[calc(100%-240px)]">
        {/* Topbar */}
        ...
        {/* Main content area */}
        <main className="flex-1 overflow-y-auto overflow-x-hidden bg-[#F3F7F6] p-4 lg:p-8 min-w-0">
          <Outlet />
        </main>
      </div>
    </div>
