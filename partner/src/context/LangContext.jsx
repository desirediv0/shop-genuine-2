...
const translations = {
    en: {
        ...
        dashboard_subtitle: "Here's an overview of your partnership performance with Shop Genuine.",
    ...
    hi: {
        ...
        dashboard_subtitle: 'Shop Genuine के साथ आपकी पार्टनरशिप का सारांश',
