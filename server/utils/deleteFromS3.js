...
export const getFileUrl = (filename) => {
  ...
  // Rows written by older uploads already store a fully-qualified URL.
  // Prefixing those again yields ".../https://.../key.jpg", which only works
  // because the CDN tolerates it — so hand absolute URLs back untouched.
