...
export const getProductsByType = asyncHandler(async (req, res) => {
  ...
  const storeTypeFilter = storeVerticalId ? { storeVerticalId } : {};
...
// Get active store verticals (public) - used for client navbar tabs
export const getActiveStoreVerticals = asyncHandler(async (req, res) => {
