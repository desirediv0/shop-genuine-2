  ...
  try {
    ...
    return res.status(200).json(
      new ApiResponsive(200, {
        title: "About Us",
        content:
          "<h2>Our Story</h2><p>Founded in 1998, Shop Genuine started with a simple mission: to provide high-quality, farm-fresh grocery products that are pure, nutritious, and free from harmful additives.</p><p>Our founder was dedicated to preserving the traditional goodness of grocery while modernizing the supply chain. We believe in transparency and the farm-to-table philosophy.</p><p>Today, we've grown into one of the region's most trusted grocery brands, with a commitment to quality, freshness, and customer satisfaction that remains as strong as ever.</p>",
        metaTitle: "About Us | Shop Genuine",
        metaDescription: "Learn more about Shop Genuine and our farm-fresh grocery mission.",
      })
    );
  } catch (error) {
  ...
  try {
    ...
    if (faqs.length > 0) {
      return res.status(200).json(
        new ApiResponsive(200, {
          faqs,
          metaTitle: "Frequently Asked Questions | Shop Genuine",
          metaDescription:
  ...
  try {
    ...
    if (contactContent) {
      const contactData = {
        ...
        socialLinks: {
          facebook: "https://facebook.com/shopgenuine",
          instagram: "https://instagram.com/shopgenuine",
          twitter: "https://twitter.com/shopgenuine",
        },
      };
    ...
    const contactInfo = {
      ...
      metaTitle: "Contact Us | Shop Genuine",
      metaDescription:
        "Get in touch with the Shop Genuine expert support team. Sourcing genuine branded specialty medicines and cold chain shipping across India.",
    };
