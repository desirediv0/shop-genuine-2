...
export const PHARMA_ICON_MAP = [
  { keys: ["hair", "accessories", "headband", "clip"], Icon: Crown, color: "#F97316" },
  { keys: ["diy", "kit", "craft"], Icon: Wrench, color: "#00AEEF" },
  { keys: ["necklace", "pendant", "chain"], Icon: Gem, color: "#F97316" },
  { keys: ["earrings", "jhumka", "studs"], Icon: Sparkles, color: "#00AEEF" },
  { keys: ["ring", "bands"], Icon: Heart, color: "#F97316" },
  { keys: ["bracelets", "bangles"], Icon: Gift, color: "#00AEEF" },
  { keys: ["custom", "bespoke", "founder"], Icon: Award, color: "#F97316" },
...
export function getPharmaIcon(name = "", slug = "") {
  ...
  return { Icon: Sparkles, color: "#F97316" };
}