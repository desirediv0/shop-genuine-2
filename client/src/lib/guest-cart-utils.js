...
const GUEST_CART_KEY = "shop-genuine_guest_cart";
    ...
    try {
        ...
        if (typeof productVariantId === "object" && productVariantId !== null) {
            ...
            newItem = {
                ...
                image: customObj.image || customObj.images?.[0]?.url || customObj.images?.[0] || "/gc_lavender_perfume.png",
            ...
            const apiBase = process.env.NEXT_PUBLIC_API_URL || (process.env.NODE_ENV === "development" ? "http://localhost:4004/api" : "https://api.shopgenuine.online/api");
            ...
            newItem = {
                ...
                image: variant.images?.[0]?.url || variant.product?.image || "/gc_lavender_perfume.png",
                sku: variant.sku,
