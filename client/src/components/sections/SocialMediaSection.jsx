...
const SOCIALS = [
  {
    name: "Instagram",
    handle: "@shopgenuine",
    url: "https://www.instagram.com/shopgenuine",
    icon: Instagram,
    accent: "#E1306C",
  ...
  {
    name: "Facebook",
    handle: "shopgenuinefamily",
    url: "https://www.facebook.com/shopgenuinefamily",
    icon: Facebook,
    accent: "#1877F2",
    accentBg: "rgba(24, 119, 242, 0.08)",
    desc: "Join our community for exclusive deals, new arrivals, and behind-the-scenes content from Shop Genuine.",
      ...
      <div className="max-w-6xl mx-auto px-5 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16">
          <div className="max-w-xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[11px] uppercase tracking-wider mb-5 font-semibold" style={{ background: "#F9731612", color: "#F97316" }}>
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 leading-[1.1] tracking-tight">
              ...
              <span style={{ color: "#F97316" }}>Connect with us.</span>
            </h2>
          </div>
