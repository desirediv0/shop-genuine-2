                ...
                <CarouselItem key={cat.id} className="pl-2 basis-[80px] sm:basis-[90px] md:basis-[100px]">
                  <Link href={`/category/${cat.slug}`}>
                    ...
                    >
                      ...
                      {/* Name */}
                      <span className="text-[11px] sm:text-[11px] font-semibold text-center leading-tight text-gray-600 group-hover:text-primary transition-colors max-w-[72px] line-clamp-2">
                        {cat.name}
                      </span>
                    </motion.div>
                  </Link>
