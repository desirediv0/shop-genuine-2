...
const FALLBACK_SLIDES = [
  {
    ...
    title: "Step Into the World of Shop Genuine",
    ...
    return (
      <div className="relative w-full h-[88vh] md:h-screen bg-noir flex items-center justify-center luxe-grain">
        <div className="flex flex-col items-center gap-6">
          <span className="font-display text-2xl tracking-[0.1em] text-ivory/60 uppercase">SHOP GENUINE</span>
  ...
  return (
    <section className="w-full relative overflow-hidden bg-noir text-ivory">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              >
                ...
                <span className="luxe-eyebrow-dark">Shop Genuine — Maison de Mode</span>
              </motion.div>
              ...
              <motion.p
                ...
                className="text-sm sm:text-[15px] text-white/70 font-normal leading-relaxed tracking-wide mb-10 max-w-md"
              >
                {active.subtitle}
              </motion.p>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-30">
        <div className="max-w-7xl mx-auto px-6 sm:px-12 md:px-16 pb-7 md:pb-9 flex items-end justify-between gap-6">
          ...
          <div className="hidden lg:flex items-center gap-3 text-white/50">
            <span className="text-[11px] uppercase tracking-[0.03em]">Scroll</span>
            <motion.span
              animate={{ y: [0, 6, 0] }}
      ...
      <div className="absolute right-6 top-1/2 -translate-y-1/2 z-30 hidden xl:block pointer-events-none" aria-hidden="true">
        <span className="block text-[11px] uppercase tracking-[0.6em] text-white/35 [writing-mode:vertical-rl]">
