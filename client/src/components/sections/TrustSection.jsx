...
const TESTIMONIALS = [
  {
    ...
    role: "Collector",
    city: "Delhi",
    text: "Exquisite necklaces that are perfect for wedding occasions. Every detail is perfect, and it came in a beautiful signature box. Shop Genuine is my go-to for unique accessories.",
    rating: 5,
    verified: true
  },
  {
  ...
  },
  {
    ...
    role: "Collector",
    city: "Pune",
    text: "I absolutely adore the festive sets from Shop Genuine. They feel premium, lightweight, and carry a distinct ethnic style that stands out from typical mass-produced jewelry.",
    rating: 5,
    verified: true
  },
  {
                ...
                <div className="flex items-center gap-4 pt-6 border-t border-gray-50 relative z-10">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-1.5 mb-0.5">
                      ...
                      {t.verified && <CheckCircle2 className="w-3.5 h-3.5 text-[#F97316] fill-[#F97316]/10" />}
                    </div>
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16">
          ...
          <p className="text-gray-500 max-w-xs md:text-right text-base leading-relaxed">
            From customized wedding adornments to elegant festive sets, Shop Genuine is the trusted choice for handcrafted jewelry.
          </p>
        </div>
