      ...
      <AnimatePresence>
        {!ready && (
          <motion.div
            ...
            aria-hidden="true"
          >
            <span className="font-display italic text-2xl text-white/40">SHOP GENUINE</span>
          </motion.div>
        )}
      </AnimatePresence>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              >
                ...
                <span className="luxe-eyebrow-dark">Shop Genuine — Future Atelier</span>
              </motion.div>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-20">
        <div className="max-w-7xl mx-auto px-6 sm:px-12 md:px-16 pb-7 md:pb-9 flex items-end justify-between gap-6">
          ...
          <div className="hidden lg:flex items-center gap-3 text-white/50">
            <span className="text-[11px] uppercase tracking-[0.03em]">Scroll to explore</span>
            <motion.span
              animate={{ y: [0, 6, 0] }}
