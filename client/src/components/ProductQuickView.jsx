        ...
        <div className="flex flex-col md:flex-row overflow-y-auto md:overflow-hidden max-h-[92vh]">
          ...
          <div className="md:w-[44%] bg-gray-50 flex flex-col flex-shrink-0">
            <div className="relative" style={{ aspectRatio: "1 / 1" }}>
              {/* Badge */}
              {hasFlashSale && (
                <span className="absolute top-3 left-3 z-10 flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px]   bg-orange-500 text-white shadow-sm">
                  <Zap className="h-2.5 w-2.5" /> FLASH SALE
                </span>
              )}
              {!hasFlashSale && discountPct > 0 && (
                <span className="absolute top-3 left-3 z-10 px-2.5 py-1 rounded-full text-[11px]   bg-red-500 text-white shadow-sm">
                  -{discountPct}% OFF
                </span>
              )}
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <div className="px-5 pt-5 pb-4 border-b border-gray-100 flex-shrink-0">
              ...
              <div className="flex items-baseline gap-2 mt-3">
                ...
                {discountPct > 0 && (
                  <span className="text-[11px]   bg-red-50 text-red-500 px-1.5 py-0.5 rounded-md">-{discountPct}%</span>
                )}
              </div>
            </div>
            ...
            <div className="px-5 pb-5 pt-3 border-t border-gray-100 space-y-3 flex-shrink-0">
              ...
              <div className="flex items-center gap-3">
                <span className="text-[11px] font-semibold text-gray-400 uppercase tracking-widest">Qty</span>
                ...
                {stock !== null && stock <= 5 && stock > 0 && (
                  <span className="text-[11px] text-orange-500 font-semibold">Only {stock} left!</span>
                )}
              </div>
