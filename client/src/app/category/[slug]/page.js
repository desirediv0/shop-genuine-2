    ...
    if (loading && !category) {
        return (
            <div className="min-h-screen" style={{ background: "#F7FAFC" }}>
                <div className="py-12 md:py-14" style={{ background: "linear-gradient(135deg, #2A2A35, #3A3A48)" }}>
        ...
        return (
            <div className="min-h-screen bg-white flex items-center justify-center px-4">
                <div className="bg-white border border-red-200 rounded-2xl p-8 max-w-md w-full text-center">
                    ...
                    <Link href="/categories" className="inline-flex items-center px-5 py-2.5 text-white rounded-xl font-semibold hover:opacity-90 transition-all border border-[#F97316]/20" style={{ background: "#2A2A35" }}>
                        <ChevronLeft className="w-4 h-4 mr-1 text-[#F97316]" /> Back to Categories
                    </Link>
                </div>
            </div>
        );
    ...
    return (
        <div className="min-h-screen" style={{ background: "#F7FAFC" }}>
            ...
            <section
                ...
                style={{ background: "linear-gradient(135deg, #2A2A35 0%, #3A3A48 60%, #222222 100%)" }}
            >
                <div className="absolute inset-0 pointer-events-none overflow-hidden">
                    <div className="absolute -top-20 right-0 w-72 h-72 rounded-full opacity-10" style={{ background: "radial-gradient(circle, #F97316, transparent 70%)" }} />
                </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-5 font-sans">
                        ...
                        >
                            {category?.image ? (
                                ...
                                <CatIcon size={40} style={{ color: "#F97316" }} />
                            )}
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-6 md:py-8">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-16">
                        ...
                        <Link href="/products" className="inline-flex items-center px-6 py-3 rounded-xl text-white font-semibold hover:opacity-90 transition-colors border border-[#F97316]/30" style={{ background: "#2A2A35" }}>
