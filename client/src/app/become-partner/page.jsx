...
const translations = {
  ...
  hero_title: "Become a Shop Genuine Partner",
  hero_subtitle:
  ...
  benefits_title: "Why Join Shop Genuine?",
  ...
  success_msg:
    "Thank you for your interest in Shop Genuine. Our partnership team will reach out to you within 48 hours.",
  ...
  return (
    <>
      ...
      <div className="partner-root min-h-screen bg-[#f8f7f4]">
        ...
        {/* ───── HERO ───── */}
        <section className="relative bg-[#2A2A35] text-white overflow-hidden">
          {/* grid overlay */}
        ...
        <section className="py-24 px-6 stripe-bg">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="font-display text-4xl md:text-5xl   text-[#2A2A35] leading-tight">
                {t.benefits_title}
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {benefits.map((b, i) => (
                <div key={i} className="benefit-card bg-white rounded-2xl p-7 border border-gray-100 shadow-sm flex flex-col">
                  ...
                  <h3 className="font-display   text-[#2A2A35] text-lg mb-2">{b.title}</h3>
        ...
        <section className="py-20 px-6 bg-[#2A2A35] overflow-hidden relative">
          ...
          <div className="max-w-2xl mx-auto">
            {success ? (
              <div className="text-center py-16">
                ...
                <h2 className="font-display text-3xl   text-[#2A2A35] mb-3">{t.success_title}</h2>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input type="text" name="name" value={form.name} onChange={handleChange}
                          ...
                          className="partner-input w-full px-4 py-3 border-2 border-gray-100 rounded-xl bg-gray-50 text-[#2A2A35] text-sm font-medium placeholder:text-gray-300" />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <textarea name="message" value={form.message} onChange={handleChange}
                        ...
                        rows={4}
                        className="partner-input w-full px-4 py-3 border-2 border-gray-100 rounded-xl bg-gray-50 text-[#2A2A35] text-sm font-medium placeholder:text-gray-300 resize-none" />
                    </div>
